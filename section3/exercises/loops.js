...
// EXPLAIN:
// 0, 1, 2 is logged to the console because the variable is set at 0 and the condition
// is set to less than 3, so the increments added to the variable each time would
// result in 0, 1, 2.
