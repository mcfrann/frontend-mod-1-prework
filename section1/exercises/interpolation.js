...
// Line 22 will log a string data type because it is a line of text, numbers,
// and an explanation point between backticks.
...
console.log(`I bought ${quantity} ${supplies} for my ${purpose}!`)
