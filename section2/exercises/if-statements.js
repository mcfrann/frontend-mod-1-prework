...
// If the dog is 3, then it is an adult.

if (dogAge <= 2) {
  console.log("It's a puppy!");
} else if (dogAge >= 10) {
  console.log("It's elderly... :(");
} else {
...
Question: Why did the exercise before the last one need a logical operator? I didn't
find that to be the case but maybe I did it wrong...??
